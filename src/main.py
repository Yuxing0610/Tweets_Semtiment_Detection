...
flags.DEFINE_string('model', default='bertweet', help='model')
flags.DEFINE_bool('load_model', default=True, help='load_model')
flags.DEFINE_string('load_model_path', default='', help='load_model_path')
...
# embedding methods
flags.DEFINE_string('glove_method', default='merged', help='glove_method')
flags.DEFINE_bool('glove_visualize', default=False, help='glove_visualize')
flags.DEFINE_string('aggregated_method', default='mean', help='aggregated_method')
flags.DEFINE_string('classify_method', default='RR', help='classify_method')
flags.DEFINE_integer('fasttext_dim', default=200, help='fasttext_dim')
flags.DEFINE_integer('fasttext_epoch', default=50, help='fasttext_epoch')
flags.DEFINE_integer('ngrams', default=4, help='ngrams')
flags.DEFINE_string('embedding_method', default='skipgram', help='embedding_method')
flags.DEFINE_bool('fasttext_visualize', default=False, help='fasttext_visualize')
flags.DEFINE_string('cnn_parameter_option', default='load', help='cnn_parameter_option')
